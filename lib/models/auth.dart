...
class Auth with ChangeNotifier {
  ...
  bool get isAuth {
    final isValidToken = _expireDate?.isAfter(DateTime.now()) ?? false;

    return _token != null && isValidToken;
  }
  ...
  Future<void> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlFragment?key=AIzaSyBSERfmZa-qEbX75KNRXEAgvJvZAlvCl7I';
